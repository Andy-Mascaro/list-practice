...
test('renderAnimal should return a <div> with animals info', (expect) => {
...
test('renderSoda should return a <div> with sodas info', (expect) => {
...
test('renderSport should return a <div> with sports info', (expect) => {
